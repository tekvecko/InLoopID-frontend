...
def compliance_report_pdf():
    ...
    for cred in credentials:
        ...
        pdf.cell(0, 5, f"ID: {cred.credential_id} | DID: {cred.subject_did}", new_x="LMARGIN", new_y="NEXT")
        pdf.cell(0, 5, f"    STATUS: {cred.status.upper()} | HASH: {hash_short}", new_x="LMARGIN", new_y="NEXT")
        pdf.ln(2)
