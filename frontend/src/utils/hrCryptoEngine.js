...
export const encryptForHR = async (payloadString, masterPassword = "inloop-master-key-demo") => {
    ...
    // --- VIZUÁLNÍ KRYPTOGRAFIE (WOW EFEKT) ---
    if (typeof window !== 'undefined') {
        window.dispatchEvent(new CustomEvent('inloop:crypto-start', { detail: { payload: payloadString } }));
    }
    // Počkáme 3.2 vteřiny, než animace doběhne, a pak provedeme reálné šifrování
